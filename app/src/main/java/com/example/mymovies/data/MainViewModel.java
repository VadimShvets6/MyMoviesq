...
public class MainViewModel extends AndroidViewModel {
    ...
    public void deleteFavouriteMovie(FavoriteMovie movie) {
        new DeletetFavouriteTask().execute(movie);
    }

    private static class DeletetFavouriteTask extends AsyncTask<FavoriteMovie, Void, Void> {
        @Override
    ...
    private static class GetFavouriteMovieTask extends AsyncTask<Integer, Void, FavoriteMovie> {
        @Override
